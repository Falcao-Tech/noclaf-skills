...
- [code-reviewer](code-reviewer.md) — gate de qualidade somente-leitura (Opus) que valida um diff contra o harness + critérios do ticket; devolve o veredito canônico `approved`/`changes_requested` + motivos. Complementa os hooks mecânicos.
