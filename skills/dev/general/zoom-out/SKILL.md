...
---
Não conheço bem esta área do código. Suba uma camada de abstração. Me dê um mapa de todos os módulos e callers relevantes, usando o vocabulário do glossário de domínio do projeto.
