...
2. Spawne os 5 conselheiros EM PARALELO (um agente por lente), cada um instruído a NÃO ser diplomático:
   - **O Contrário** — rasga a ideia, acha os 3 furos que vão matá-la. Proibido elogiar.
   - **Primeiros Princípios** — ignora a pergunta, reformula o que você TENTA resolver de verdade e diz se a decisão é a alavanca certa.
   - **O Expansionista** — caça o ganho 10x que você não está vendo.
   - **O Forasteiro** — recebe só a decisão em 1 frase, sem contexto; aponta o óbvio que você parou de notar de tão dentro.
   - **O Executor** — só liga pro que muda amanhã de manhã: menor passo testável, custo de errar.
3. Revisão entre pares: cruze as 5 saídas, marque o que sobrevive e as divergências reais (não invente concordância).
